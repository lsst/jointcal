...
class Associations;
/* The following declarations are useless, because those classes are
fully defined in the header files included above. But the C++ glue
generated by swig is syntactically incorrect without them... */
